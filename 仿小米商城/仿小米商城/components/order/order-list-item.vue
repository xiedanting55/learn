<template>
	<view class="border-bottom d-flex a-center py-2 border-light-secondary" @click="open">
		<image :src="item.cover" mode="widthFix" style="width: 150rpx;height: 150rpx;" class="rounded mx-2 flex-shrink">
		</image>
		<view class="flex-1">
