<template>
	<view class="page main-bg-gray-color">
		<!-- 圆通快递 -->
		<view class="express">
			<view class="top ali-c">
				<view class="picture">
					<image class="img" mode="aspectFill" src="/static/images/sf.png"></image>
				</view>
				<view class="text">
					<view class="text1">顺丰速运</view>
					<view class="text2">官方电话 95338</view>
				</view>
			</view>
			<view class="right d-flex a-center">
				<view class="text">顺丰速运 {{wlInfo.post_no}}</view>
				<text class="border rounded copy px-1 main-text-20 ml-2" @click="copyInfo(wlInfo.post_no)">复制</text>
			</view>
		</view>
		...
		<view class="content bgf">
			<view>
				...
				<view class="flex list" :class="{one: index == 0 && wlInfo.state == 2}" v-for="(item, index) in wlInfo.list" :key="index">
					<view class="time">
