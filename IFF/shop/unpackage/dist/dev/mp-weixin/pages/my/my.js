...
/* harmony import */ var _my_vue_vue_type_style_index_0_id_0be17cc6_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./my.vue?vue&type=style&index=0&id=0be17cc6&lang=scss&scoped=true& */ 49);
        ...
        success: function success(loginRes) {
          uni.getUserInfo({
            ...
            success: function success(infoRes) {
              var data = infoRes.userInfo;
              _this.$H.post('Index/getUserInfo', {
                code: loginRes.code }).
              then(function (res) {
                // 状态存储
